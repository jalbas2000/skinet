...
namespace API.Controllers
{
    public class ProductsController : BaseApiController
    {
        ...
        public async Task<ActionResult<ProductToReturnDto>> AddProductPhoto(int id, [FromForm]ProductPhotoDto photoDto)
        {
            ...
            if (product == null) return NotFound(new ApiResponse(404, "No Product found for id " + id));
        ...
        public async Task<ActionResult> DeleteProductPhoto(int id, int photoId)
        {
            ...
            if (photo != null)
            {
                ...
                return BadRequest(new ApiResponse(404, "Photo does not exist"));
            }
        ...
        public async Task<ActionResult<ProductToReturnDto>> SetMainPhoto(int id, int photoId)
        {
            ...
            if (product.Photos.All(x => x.Id != photoId)) return NotFound(new ApiResponse(404, "Photo does not exist"));
            ...
            if (result <= 0) return BadRequest(new ApiResponse(400, "Problem set photo as main."));
